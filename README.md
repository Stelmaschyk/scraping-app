...
2. **Натискається кнопка "Load More"** один раз
3. **Сторінка прокручується** до самого низу з автоматичним завантаженням
4. **Скрапляться всі вакансії** без фільтрації за функціями
5. **Job Functions зберігаються** в БД для аналітики
...
- Обробляє всі вакансії без фільтрації
...
- **Фільтрація за job functions відключена** - обробляються всі вакансії
